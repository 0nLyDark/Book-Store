...
public class SecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        // "https://b4b3-2405-4802-8008-5730-2128-d62-1739-62a0.ngrok-free.app", // nếu
        // frontend máy khác customer
        // "https://bcef-2402-800-63b8-bcfc-7010-af69-2e41-78d7.ngrok-free.app", // nếu
        // frontend máy khác admin
        // "https://6883-2405-4802-8008-5730-e441-dc-8ae6-29ce.ngrok-free.app" // nếu
        // frontend gọi qua ngrok
        // )); //
        configuration.setAllowedOriginPatterns(List.of("*"));
