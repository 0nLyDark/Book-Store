...
public class PostServiceImpl implements PostService {
    ...
    public PostResponse getAllPost(Integer pageNumber, Integer pageSize, String sortBy, String sortOrder) {
        ...
        List<PostDTO> postDTOs = pagePosts.getContent().stream().map(post -> modelMapper.map(post, PostDTO.class))
    ...
    public PostDTO createPost(PostDTO postDTO) {
        ...
        Topic topic = topicRepo.findById(postDTO.getTopic().getTopicId())
                .orElseThrow(() -> new ResourceNotFoundException("Topic", "topicId", postDTO.getTopic().getTopicId()));
        Post post = new Post();
    ...
    public PostDTO updatePost(PostDTO postDTO) {
        ...
        Post post = postRepo.findById(postDTO.getPostId())
                .orElseThrow(() -> new ResourceNotFoundException("Post", "postId", postDTO.getPostId()));
        post.setTitle(postDTO.getTitle());
        post.setSlug(CreateSlug.toSlug(postDTO.getTitle()));
        post.setContent(postDTO.getContent());
        post.setType(postDTO.getType());
